...
/**
 * Entry `/` no longer hosts a login form. Serve (port 3000) is the only
 * sign-in. A valid POS token — including one just dropped in via
 * `#pos_token=` — continues into the floor. Anything else goes to Serve.
 */
