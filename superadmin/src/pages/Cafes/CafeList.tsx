      ...
      {canCreate ? (
        <CreateCafeModal
          ...
          onCreated={({ cafeName, slug, ownerUsername, ownerPassword }) => {
            ...
            showToast(
              ownerPassword
                ? `Created ${cafeName}. POS: localhost:7001/?tenant=${slug}${who} · temp password: ${ownerPassword}`
                : `Created ${cafeName}. Sign in at localhost:7001/?tenant=${slug}${who} with the password you set.`,
            )
          }}
        />
      ) : null}
